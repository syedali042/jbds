    ...
    return (
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-8">
                            <img src="./images/download.jfif" alt="there is no image" style={{marginRight:10}} className="img"/>
                            <h2 className="blood" style={{padding:5}}><span style={{color:'#FF3B3B'}}>Blood</span> Center</h2><br>
                            </br>
