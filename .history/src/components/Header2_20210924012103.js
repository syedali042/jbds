    ...
    return (
        <div className="bodyOfHeader2"> 
            ...
            <div className="sidebar d-none">
                <a href=""><h4 style={{ padding: 20,color:'white' }}>Home</h4></a>
                <a href=""><h4 style={{ padding: 20, color: 'white' }}>Request</h4></a>
                <a href=""><h4 style={{ padding: 20, color: 'white' }}>Campaing</h4></a>
                <a href=""><h4 style={{ padding: 20, color: 'white' }}>Tips</h4></a>
                <a href=""><h4 style={{ padding: 20, color: 'white' }}>About</h4></a>
            </div>
        </div>
    )
}
