                                ...
                                >
                                    {({
                                        ...
                                        <form onSubmit={handleSubmit} className="formik">
                                            ...
                                            <input
                                                type="email" className="placehorder p-4 form-control em"
                                                name="email"
                                            ...
                                            <input
                                                type="number" className="placehorder p-4 form-control num"
                                                name="number"
                                                onChange={handleChange}
                                                onBlur={handleBlur}
                                                value={values.number}
                                            ...
                                            <select name="bloodGroup" className="placehorder p-4 form-control bloodGroup">
                                                <option value="volvo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                A +ve</option>
                                            ...
                                            <input
                                                type="text" className="placehorder p-4 form-control city"
                                                name="city"
                                                onChange={handleChange}
                                                onBlur={handleBlur}
                                                value={values.city}
                                            ...
                                            <input
                                                type="password" className="placehorder p-4 form-control pass"
                                                name="password"
                                                onChange={handleChange}
                                                onBlur={handleBlur}
